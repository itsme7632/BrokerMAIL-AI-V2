  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        {/* ── Right: live preview ── */}
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl flex flex-col overflow-hidden shadow-sm">
          <div className="h-12 border-b border-slate-100 dark:border-slate-700 bg-slate-50/60 dark:bg-slate-800/60 px-5 flex items-center gap-2">
            <Eye className="h-4 w-4 text-slate-400" />
            <h3 className="font-semibold text-slate-700 dark:text-slate-200 text-sm">Live Preview</h3>
          ...
          {previewMode === "html" ? (
            <div className="flex-1 flex flex-col overflow-hidden" style={{ minHeight: "420px" }}>
              {previewSubjectLine && (
                <div className="px-4 py-2 border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800">
                  <span className="text-xs text-slate-400 dark:text-slate-500 font-medium">Subject: </span>
                  <span className="text-xs text-slate-800 dark:text-slate-200 font-semibold">{previewSubjectLine}</span>
                </div>
              )}
              {previewHtml ? (
                <iframe
            ...
            <div className="p-6 flex-1 space-y-6 bg-white dark:bg-slate-900 min-h-[300px]">
              ...
              {subject ? (
                <div>
                  <div className="text-xs text-slate-400 dark:text-slate-500 uppercase font-semibold tracking-wider mb-1.5">Subject</div>
                  <div className="font-semibold text-slate-900 dark:text-slate-100 text-sm">{previewSubject}</div>
                </div>
              ) : (
