...
function SidebarPlanCard() {
  ...
  return (
    <div className="mx-3 mb-2 rounded-xl border border-slate-700/60 dark:border-slate-700 bg-slate-800/50 dark:bg-slate-800/60 p-3.5">
      <div className="flex items-center justify-between gap-2 mb-2.5">
        <div className="flex items-center gap-1.5">
          <Zap className="h-3 w-3 text-blue-400 flex-shrink-0" />
          <span className="text-xs font-semibold text-slate-200 dark:text-slate-200">
            {billing ? billing.plan.name : <span className="text-slate-500">—</span>}
          </span>
        </div>
        <Link href="/plans">
          <span className="text-[10px] font-medium text-blue-400 hover:text-blue-300 transition-colors cursor-pointer">
            Manage
          </span>
        </Link>
      </div>
